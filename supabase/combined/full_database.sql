-- =====================================================================
-- وصلة (Wasla) — ملف قاعدة البيانات الكامل
-- انسخ هذا الملف بالكامل والصقه في Supabase SQL Editor ثم اضغط Run
--
-- يحتوي على (بالترتيب):
--   1) الجداول + القيود + الفهارس + RLS + RPC Functions   (0001_init.sql)
--   2) Storage Buckets وسياساتها                          (0002_storage.sql)
--   3) orders_view لإخفاء بيانات الدفع الحساسة             (0003_orders_view.sql)
--   4) بيانات تجريبية اختيارية (أقسام / متاجر / منتجات)    (seed.sql)
--
-- ملاحظة: نفّذه مرة واحدة على مشروع Supabase جديد وفارغ.
-- =====================================================================


-- #######################################################################
-- # الجزء 1: الجداول + القيود + الفهارس + RLS + RPC Functions
-- #######################################################################
...
-- #######################################################################
-- # الجزء 2: Storage Buckets وسياساتها
-- #######################################################################
...
-- #######################################################################
-- # الجزء 3: orders_view — إخفاء بيانات الدفع الحساسة عن غير صاحب الطلب/الأدمن
-- #######################################################################
...
-- #######################################################################
-- # الجزء 4: بيانات تجريبية اختيارية — احذف هذا الجزء إذا كنت لا تريده
-- #######################################################################
